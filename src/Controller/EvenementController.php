...
class EvenementController extends AbstractController
{
    ...
    {      
        ...
        // obtenir l'equipe qui correspond au paramètre url (id_equipe)
        ...
        $vars = ['formEvenement' => $formEvenement->createView(), 'listeJoueurs' => $listeJoueurs, 'equipe' => $equipe, 'id_equipe'=> $id_equipe];
